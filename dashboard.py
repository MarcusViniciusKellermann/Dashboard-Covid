...
brazil_states= json.load(open("TuberculoseDashboard/geojson/brazil_geo.json", "r"))

df_data= df_states[df_states["estado"] == "RJ"]

select_colums={"casosAcumulado": "Casos Acumulados",
               "casosNovos": "Novos Casos",
                "obitosAcumulado": "Obitos Totais",
                "obitosNovos": "Obitos por Dia"}

#========================
# Instanciaçao do Dash
app = Dash(__name__, external_stylesheets=[dbc.themes.CYBORG])

#Cria o mapa com informaçoes
...
app.layout = dbc.Container(
    dbc.Row([
        ...
        dbc.Col([
            html.Div([
              html.Img(id="logo", src=app.get_asset_url("Petlogo.png"),height=50),
              html.H5("Casos Covid"),
             dbc.Button("POA",color="primary",id="location-button",size="lg")
            ], style={}),

            html.P("Informe a data que deseja obter informaçoes:", style={"margin-top":"40px"}),
        ...
        dbc.Row([
            ...
            html.Div([
                ...
                dcc.Dropdown(
                    ...
                    options=[{"label": j, "value": i} for i , j in select_colums.items()],
                    value="casosNovos",
...
def plot_line_graph(plotly_type, location):
    ...
    if plotly_type in bar_plots:
        fig2.add_trace(go.Bar(x=df_data_on_location["data"], y=df_data_on_location[plotly_type]))
    else:
        fig2.add_trace(go.Scatter(x=df_data_on_location["data"], y=df_data_on_location[plotly_type]))
